.class public LCleaner/Royall/zn;
.super Ljava/lang/Object;


# static fields
.field private static b:LCleaner/Royall/zn;
...
.method public static declared-synchronized a()LCleaner/Royall/zn;
    .locals 2

    const-class v0, LCleaner/Royall/zn;

    monitor-enter v0

    :try_start_0
    sget-object v1, LCleaner/Royall/zn;->b:LCleaner/Royall/zn;

    if-nez v1, :cond_0

    new-instance v1, LCleaner/Royall/zn;

    invoke-direct {v1}, LCleaner/Royall/zn;-><init>()V

    sput-object v1, LCleaner/Royall/zn;->b:LCleaner/Royall/zn;
...
.method private b()Lokhttp3/OkHttpClient;
    ...
    iget-object v0, p0, LCleaner/Royall/zn;->a:Lokhttp3/OkHttpClient;
    ...
    new-instance v2, LCleaner/Royall/zo;

    invoke-direct {v2, p0}, LCleaner/Royall/zo;-><init>(LCleaner/Royall/zn;)V
    ...
    new-instance v1, LCleaner/Royall/zp;

    invoke-direct {v1, p0}, LCleaner/Royall/zp;-><init>(LCleaner/Royall/zn;)V
    ...
    iput-object v0, p0, LCleaner/Royall/zn;->a:Lokhttp3/OkHttpClient;
...
# virtual methods
.method public a(LCleaner/Royall/zl;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;LCleaner/Royall/zm;)V
    .locals 6
    ...
    invoke-virtual {p1}, LCleaner/Royall/zl;->b()Ljava/util/HashMap;
    ...
    :goto_1
    :try_start_0
    invoke-virtual {p1}, LCleaner/Royall/zl;->d()I
    ...
    :try_start_3
    invoke-virtual {p1}, LCleaner/Royall/zl;->a()Ljava/util/HashMap;
    ...
    invoke-direct {p0}, LCleaner/Royall/zn;->b()Lokhttp3/OkHttpClient;
    ...
    new-instance p3, LCleaner/Royall/zq;

    invoke-direct {p3, p0, p1, p5, p4}, LCleaner/Royall/zq;-><init>(LCleaner/Royall/zn;LCleaner/Royall/zl;LCleaner/Royall/zm;Ljava/lang/String;)V
    ...
    invoke-interface {p5, p4, p1}, LCleaner/Royall/zm;->a(Ljava/lang/String;Ljava/lang/String;)V
