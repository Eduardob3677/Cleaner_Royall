...
# direct methods
.method public static synthetic $r8$lambda$OLKMTq1dJMsIR38eU3dpIsBkCzg(LCleaner/Royall/ky;Landroid/widget/CheckBox;)V
    .locals 0

    invoke-direct {p0, p1}, LCleaner/Royall/ky;->a(Landroid/widget/CheckBox;)V

    return-void
.end method

.method public static synthetic $r8$lambda$tvoVwNo0E2IkhL6FtXCYAd9dkBk(LCleaner/Royall/ky;LCleaner/Royall/zw;)V
    .locals 0

    invoke-direct {p0, p1}, LCleaner/Royall/ky;->a(LCleaner/Royall/zw;)V

    return-void
.end method

.method constructor <init>(LCleaner/Royall/kv;Landroid/widget/CheckBox;)V
    .locals 0

    iput-object p1, p0, LCleaner/Royall/ky;->a:LCleaner/Royall/kv;

    iput-object p2, p0, LCleaner/Royall/ky;->b:Landroid/widget/CheckBox;
...
.method private synthetic a(LCleaner/Royall/zw;)V
    ...
    iget-object v0, p0, LCleaner/Royall/ky;->a:LCleaner/Royall/kv;

    invoke-static {v0}, LCleaner/Royall/kv;->a(LCleaner/Royall/kv;)LCleaner/Royall/MainActivity;
...
.method private synthetic a(Landroid/widget/CheckBox;)V
    ...
    iget-object p1, p0, LCleaner/Royall/ky;->a:LCleaner/Royall/kv;
    ...
    iget-object v1, p0, LCleaner/Royall/ky;->a:LCleaner/Royall/kv;

    invoke-static {v1}, LCleaner/Royall/kv;->a(LCleaner/Royall/kv;)LCleaner/Royall/MainActivity;
    ...
    const-string v3, "/Cleaner/logs2.txt"
    ...
    const-string v2, "\ud835\udc02\ud835\udc25\ud835\udc1e\ud835\udc1a\ud835\udc27\ud835\udc22\ud835\udc27\ud835\udc20 \ud835\udc0b\ud835\udc28\ud835\udc20\ud835\udc2c Enhanced"

    const-string v3, "Trimmed All Logs + Enhanced"
    ...
    const-string v0, "Trimmed All Logs"
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object p2, p0, LCleaner/Royall/ky;->a:LCleaner/Royall/kv;

    invoke-static {p2}, LCleaner/Royall/kv;->a(LCleaner/Royall/kv;)LCleaner/Royall/MainActivity;
    ...
    const-string v2, "/Cleaner/logs.txt"
    ...
    iget-object p1, p0, LCleaner/Royall/ky;->b:Landroid/widget/CheckBox;

    new-instance v7, LCleaner/Royall/ky$$ExternalSyntheticLambda0;

    invoke-direct {v7, p0, p1}, LCleaner/Royall/ky$$ExternalSyntheticLambda0;-><init>(LCleaner/Royall/ky;Landroid/widget/CheckBox;)V

    new-instance v8, LCleaner/Royall/ky$$ExternalSyntheticLambda1;

    invoke-direct {v8, p0, v4}, LCleaner/Royall/ky$$ExternalSyntheticLambda1;-><init>(LCleaner/Royall/ky;LCleaner/Royall/zw;)V
