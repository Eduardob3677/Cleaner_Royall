...
# direct methods
.method public static synthetic $r8$lambda$H_zm-gDn2oeNOGLATD_WFtXYpS4(LCleaner/Royall/jk;)V
    .locals 0

    invoke-direct {p0}, LCleaner/Royall/jk;->d()V

    return-void
.end method

.method public static synthetic $r8$lambda$KijXyNPBItGXnBPTU37xKiA0Oqg()V
    .locals 0

    invoke-static {}, LCleaner/Royall/jk;->a()V

    return-void
.end method

.method public static synthetic $r8$lambda$b5C_3BpmJXMXs1TnMMCcg4Q-c-U(LCleaner/Royall/jk;)V
    .locals 0

    invoke-direct {p0}, LCleaner/Royall/jk;->b()V

    return-void
.end method

.method public static synthetic $r8$lambda$tOvJrraYNBg7-2RflR7SvH_NfOk(LCleaner/Royall/jk;)V
    .locals 0

    invoke-direct {p0}, LCleaner/Royall/jk;->c()V

    return-void
.end method

.method public static synthetic $r8$lambda$to0JNuDW_qD3cfmvEGQQYqqO80A(LCleaner/Royall/jk;LCleaner/Royall/zw;)V
    .locals 0

    invoke-direct {p0, p1}, LCleaner/Royall/jk;->a(LCleaner/Royall/zw;)V

    return-void
.end method

.method public static synthetic $r8$lambda$vwzw4-eDcbVXsH_QotuDTyOcxYk(LCleaner/Royall/jk;LCleaner/Royall/zw;)V
    .locals 0

    invoke-direct {p0, p1}, LCleaner/Royall/jk;->b(LCleaner/Royall/zw;)V
...
.method constructor <init>(LCleaner/Royall/FeedbackActivity;)V
    ...
    iput-object p1, p0, LCleaner/Royall/jk;->a:LCleaner/Royall/FeedbackActivity;
...
.method private synthetic a(LCleaner/Royall/zw;)V
    ...
    iget-object v0, p0, LCleaner/Royall/jk;->a:LCleaner/Royall/FeedbackActivity;

    invoke-virtual {p1}, LCleaner/Royall/zw;->a()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, LCleaner/Royall/FeedbackActivity;->-$$Nest$fpute(LCleaner/Royall/FeedbackActivity;Ljava/lang/String;)V

    iget-object p1, p0, LCleaner/Royall/jk;->a:LCleaner/Royall/FeedbackActivity;

    invoke-static {p1}, LCleaner/Royall/FeedbackActivity;->-$$Nest$fgete(LCleaner/Royall/FeedbackActivity;)Ljava/lang/String;
...
.method private synthetic b()V
    ...
    const-string v2, "You have been banned Permanently from providing Feedback.\nand can\'t Request Unban\n\nPlease Contact Developer for Help"
    ...
    :cond_0
    iget-object v3, p0, LCleaner/Royall/jk;->a:LCleaner/Royall/FeedbackActivity;

    new-instance v7, LCleaner/Royall/jk$$ExternalSyntheticLambda0;

    invoke-direct {v7, p0}, LCleaner/Royall/jk$$ExternalSyntheticLambda0;-><init>(LCleaner/Royall/jk;)V

    new-instance v8, LCleaner/Royall/jk$$ExternalSyntheticLambda1;

    invoke-direct {v8, p0}, LCleaner/Royall/jk$$ExternalSyntheticLambda1;-><init>(LCleaner/Royall/jk;)V
...
.method private synthetic b(LCleaner/Royall/zw;)V
    ...
    invoke-virtual {p1}, LCleaner/Royall/FeedbackActivity;->getApplicationContext()Landroid/content/Context;
    ...
    iget-object v1, p0, LCleaner/Royall/jk;->a:LCleaner/Royall/FeedbackActivity;

    invoke-static {v1}, LCleaner/Royall/FeedbackActivity;->-$$Nest$fgete(LCleaner/Royall/FeedbackActivity;)Ljava/lang/String;
...
.method private synthetic c()V
    ...
    iget-object v2, p0, LCleaner/Royall/jk;->a:LCleaner/Royall/FeedbackActivity;
    ...
    new-instance v5, LCleaner/Royall/jk$$ExternalSyntheticLambda4;

    invoke-direct {v5, p0, v4}, LCleaner/Royall/jk$$ExternalSyntheticLambda4;-><init>(LCleaner/Royall/jk;LCleaner/Royall/zw;)V

    new-instance v6, LCleaner/Royall/jk$$ExternalSyntheticLambda5;

    invoke-direct {v6, p0, v4}, LCleaner/Royall/jk$$ExternalSyntheticLambda5;-><init>(LCleaner/Royall/jk;LCleaner/Royall/zw;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    new-instance v8, LCleaner/Royall/jk$$ExternalSyntheticLambda2;

    invoke-direct {v8}, LCleaner/Royall/jk$$ExternalSyntheticLambda2;-><init>()V

    new-instance v10, LCleaner/Royall/jk$$ExternalSyntheticLambda3;

    invoke-direct {v10, p0}, LCleaner/Royall/jk$$ExternalSyntheticLambda3;-><init>(LCleaner/Royall/jk;)V

    const/4 v11, 0x0

    const-string v4, "\ud835\uddd8\ud835\uddff\ud835\uddff\ud835\uddfc\ud835\uddff"

    const-string v5, "You have been banned from providing Feedback."
    ...
    invoke-virtual {p1}, LCleaner/Royall/FeedbackActivity;->b()V
