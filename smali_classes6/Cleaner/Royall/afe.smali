...
# direct methods
.method public static synthetic $r8$lambda$2gHgVgmmt3OQe4XTdy4l0tBAxdM(LCleaner/Royall/afe;)V
    .locals 0

    invoke-direct {p0}, LCleaner/Royall/afe;->b()V

    return-void
.end method

.method public static synthetic $r8$lambda$2m-6pKSXk1CSfyq4MGoosP39qWY(LCleaner/Royall/afe;LCleaner/Royall/zw;)V
    .locals 0

    invoke-direct {p0, p1}, LCleaner/Royall/afe;->a(LCleaner/Royall/zw;)V

    return-void
.end method

.method public static synthetic $r8$lambda$41itnM2w_oGlVzfWX7ABoOkI49w(LCleaner/Royall/afe;)V
    .locals 0

    invoke-direct {p0}, LCleaner/Royall/afe;->c()V

    return-void
.end method

.method public static synthetic $r8$lambda$U827vgFIilRudc_r19F42aL471w(LCleaner/Royall/afe;)V
    .locals 0

    invoke-direct {p0}, LCleaner/Royall/afe;->d()V

    return-void
.end method

.method public static synthetic $r8$lambda$i8-q4T-ubMMttwOHvJPh1tuAcCM(LCleaner/Royall/afe;LCleaner/Royall/zw;)V
    .locals 0

    invoke-direct {p0, p1}, LCleaner/Royall/afe;->b(LCleaner/Royall/zw;)V

    return-void
.end method

.method public static synthetic $r8$lambda$pNHSHRPDdGinETSojhVbcR5EZmY()V
    .locals 0

    invoke-static {}, LCleaner/Royall/afe;->a()V
...
.method constructor <init>(LCleaner/Royall/SubmitdynamicActivity;)V
    ...
    iput-object p1, p0, LCleaner/Royall/afe;->a:LCleaner/Royall/SubmitdynamicActivity;
...
.method private synthetic a(LCleaner/Royall/zw;)V
    ...
    iget-object v0, p0, LCleaner/Royall/afe;->a:LCleaner/Royall/SubmitdynamicActivity;

    invoke-virtual {p1}, LCleaner/Royall/zw;->a()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, LCleaner/Royall/SubmitdynamicActivity;->-$$Nest$fputb(LCleaner/Royall/SubmitdynamicActivity;Ljava/lang/String;)V

    iget-object p1, p0, LCleaner/Royall/afe;->a:LCleaner/Royall/SubmitdynamicActivity;

    invoke-static {p1}, LCleaner/Royall/SubmitdynamicActivity;->-$$Nest$fgetb(LCleaner/Royall/SubmitdynamicActivity;)Ljava/lang/String;
...
.method private synthetic b()V
    ...
    const-string v2, "You have been banned Permanently from providing Dynamic Actions.\nand can\'t Request Unban\n\nPlease Contact Developer for Help"
    ...
    :cond_0
    iget-object v3, p0, LCleaner/Royall/afe;->a:LCleaner/Royall/SubmitdynamicActivity;

    new-instance v7, LCleaner/Royall/afe$$ExternalSyntheticLambda2;

    invoke-direct {v7, p0}, LCleaner/Royall/afe$$ExternalSyntheticLambda2;-><init>(LCleaner/Royall/afe;)V

    new-instance v8, LCleaner/Royall/afe$$ExternalSyntheticLambda3;

    invoke-direct {v8, p0}, LCleaner/Royall/afe$$ExternalSyntheticLambda3;-><init>(LCleaner/Royall/afe;)V
...
.method private synthetic b(LCleaner/Royall/zw;)V
    ...
    invoke-virtual {p1}, LCleaner/Royall/SubmitdynamicActivity;->getApplicationContext()Landroid/content/Context;
    ...
    iget-object v1, p0, LCleaner/Royall/afe;->a:LCleaner/Royall/SubmitdynamicActivity;

    invoke-static {v1}, LCleaner/Royall/SubmitdynamicActivity;->-$$Nest$fgetb(LCleaner/Royall/SubmitdynamicActivity;)Ljava/lang/String;
...
.method private synthetic c()V
    ...
    iget-object v2, p0, LCleaner/Royall/afe;->a:LCleaner/Royall/SubmitdynamicActivity;
    ...
    new-instance v5, LCleaner/Royall/afe$$ExternalSyntheticLambda4;

    invoke-direct {v5, p0, v4}, LCleaner/Royall/afe$$ExternalSyntheticLambda4;-><init>(LCleaner/Royall/afe;LCleaner/Royall/zw;)V

    new-instance v6, LCleaner/Royall/afe$$ExternalSyntheticLambda5;

    invoke-direct {v6, p0, v4}, LCleaner/Royall/afe$$ExternalSyntheticLambda5;-><init>(LCleaner/Royall/afe;LCleaner/Royall/zw;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    new-instance v8, LCleaner/Royall/afe$$ExternalSyntheticLambda0;

    invoke-direct {v8}, LCleaner/Royall/afe$$ExternalSyntheticLambda0;-><init>()V

    new-instance v10, LCleaner/Royall/afe$$ExternalSyntheticLambda1;

    invoke-direct {v10, p0}, LCleaner/Royall/afe$$ExternalSyntheticLambda1;-><init>(LCleaner/Royall/afe;)V
    ...
    invoke-virtual {p1}, LCleaner/Royall/SubmitdynamicActivity;->c()V
