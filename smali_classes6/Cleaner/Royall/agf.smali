...
.method constructor <init>(LCleaner/Royall/TelegramActivity;)V
    ...
    iput-object p1, p0, LCleaner/Royall/agf;->a:LCleaner/Royall/TelegramActivity;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, LCleaner/Royall/agf;->a:LCleaner/Royall/TelegramActivity;

    const-string v1, "\ud835\udde7\ud835\uddff\ud835\uddee\ud835\ude00\ud835\uddf5 & \ud835\uddd6\ud835\uddee\ud835\uddf0\ud835\uddf5\ud835\uddf2 \ud835\uddd6\ud835\uddf9\ud835\uddf2\ud835\uddee\ud835\uddfb\ud835\uddf2\ud835\uddff"

    const-string v2, "#!/system/bin/sh\n\nif [ -d \"/data/media/0\" ]; then\n    INT=\"/data/media/0\"\nelif [ -d \"/storage/emulated/0\" ]; then\n    INT=\"/storage/emulated/0\"\nelse\n    INT=\"/sdcard\"\nfi\n\n\n\nrm -rf \"/data/data/org.telegram.messenger/code_cache\"\nrm -rf \"/data/data/org.telegram.messenger/cache\""

    const-string v3, "It can Delete Trash & Cached data of Telegram"

    const-string v4, "\nP1=\"/data/data/org.telegram.messenger/cache\"\n\nP2=\"/data/data/org.telegram.messenger/code_cache\"\n"

    const-string v5, "none"

    const-string v6, "none"

    const-string v7, "It can clean Trash & Cache from /data\n\n\"/data/data/org.telegram.messenger/cache\"\n\"/data/data/org.telegram.messenger/code_cache\""
